  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          " text-custom-textLight rounded-md w-9 font-normal text-[0.8rem] w-full",
        row: "flex w-full ",
        ...
        day_selected:
          "bg-custom-primary text-primary-foreground hover:border hover:border-custom-primary ",
        day_today: "bg-custom-primary text-white",
        day_outside:
          "day-outside text-custom-textLight aria-selected:bg-accent/50 aria-selected:text-custom-textLight",
        day_disabled: "text-custom-textLight opacity-50",
        day_range_middle:
